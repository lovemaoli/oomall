...
public class WeightTemplateTest {
    ...
    public void testJsonWhenWeigh() {
        RegionTemplate template = new WeightTemplate() {
            {
                setId(1L);
                setUnit(1);
                setRegionId(112L);
        ...
        assertEquals("{\"id\":1,\"creatorId\":1,\"creatorName\":\"admin\",\"upperLimit\":100,\"unit\":1,\"regionId\":112,\"templateId\":1,\"firstWeight\":1,\"firstWeightPrice\":100,\"thresholds\":[{\"below\":10,\"price\":10},{\"below\":100,\"price\":100},{\"below\":200,\"price\":200}],\"templateBean\":\"weightTemplateDao\"}", JacksonUtil.toJson(template));
    }
